...
$st = new IDNstemmer();
$konek = new  mysqli_connect("localhost","root"," ","uas");
...
if (move_uploaded_file($lokasi_file,'$folder')){
  ...
  $conn = new mysqli_connect("localhost","root"," ","uas");
  $query = "INSERT INTO uas (nama_file, deskripsi, tgl_upload)
  ...
  echo $nama_file;
 // $nama_file="./folder/"."uupangan13.pdf";
 $nama_file="./files/".$nama_file;
    echo ">>>>>>>>>>>>>>>>".$nama_file;
 // $a->setFilename('./folder/uupangan13.pdf');
